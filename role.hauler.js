...
var roleHauler = {
    ...
    deliverResources: function(creep) {
        ...
        switch (creep.memory.task) {
            ...
            case 'terminalHauler':
                if (creep.store[RESOURCE_ENERGY] > 50 && creep.room.storage.store[RESOURCE_ENERGY] <= 5000) {
                    target = creep.room.storage
                } else {
        ...
        for (const resourceType in creep.store) {
            ...
            if (result === ERR_NOT_IN_RANGE) {
                ...
                if (creep.memory.task === 'terminalHauler') {
                    ...
                    if (newTotal > 0) {
                        marketData.costBasis = ((marketData.costBasis + 0.0001) * marketData.storedAmount) / newTotal;
                    }
